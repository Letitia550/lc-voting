    ...
    >
        @auth
            <form wire:submit.prevent="addComment" action="#" class="space-y-4 px-4 py-6">
                <div>
                    <textarea x-ref="comment" wire:model="comment" name="post_comment" id="post_comment" cols="30" rows="4" class="w-full text-sm bg-gray-100 rounded-xl placeholder-gray-900 border-none px-4 py-2"
        ...
        @else
            <div class="px-4 py-6">
                ...
                <div class="flex space-x-3 items-center mt-8">
                    <a
                        href="{{ route('login') }}"
                        class="text-center inline-block justify-center w-1/2 h-11 rounded-xl bg-blue border border-blue hover:bg-blue-hover
                    ...
                    <a
                        href="{{ route('register') }}"
                        class="text-center inline-block justify-center w-1/2 h-11 rounded-xl bg-gray-200 border border-gray-200 hover:border-gray-400

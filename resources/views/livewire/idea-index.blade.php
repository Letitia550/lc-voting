...
>
    <div class="hidden md:block border-r border-gray-100 px-5 py-8">
        ...
        @if ($hasVoted)
            <div class="mt-8">
                <button class="w-20 bg-blue border text-white border-blue hover:bg-blue-hover transition duration-150 easy-in font-bold text-xxs uppercase
                        rounded-xl px-4 py-3">Voted</button>
            </div>
        @else
            <div class="mt-8">
        ...
        <div class="flex flex-col justify-between w-full mx-2 md:mx-4">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    ...
                    @if ($hasVoted)
                        <button class="w-20 bg-blue border border-blue text-white hover:bg-blue-hover transition duration-150 easy-in font-bold text-xxs uppercase
                                rounded-xl px-4 py-3 -mx-5">Voted</button>
                    @else
                        <button class="w-20 bg-gray-200 border border-white transition hover:bg-gray-200 duration-150 easy-in font-bold text-xxs uppercase
